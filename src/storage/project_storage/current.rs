...
use crate::projects::{ProjectMetadataV3, SectionOrTocV4, SectionV4};
...
impl ProjectDataV7 {
    ...
    pub fn insert_section_after(
        ...
        match pos {
            Some(pos) => {
                self.sections
                    .insert(pos + 1, SectionOrTocV4::Section(section_to_insert));
                Ok(())
            }
            None => {
                for section in &mut self.sections {
