...
use rocket::State;
use crate::data_storage::{ProjectDataV6, ProjectStorage};
...
pub async fn get_project(project_id: &uuid::Uuid, settings: &State<Settings>, project_storage: Arc<ProjectStorage>) -> Result<Arc<RwLock<ProjectDataV6>>, Json<ApiResult<ApiError>>>{
