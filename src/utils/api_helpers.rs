...
use rocket::State;
use crate::data_storage::{ProjectDataV4, ProjectStorage};
...
pub async fn get_project(project_id: &uuid::Uuid, settings: &State<Settings>, project_storage: Arc<ProjectStorage>) -> Result<Arc<RwLock<ProjectDataV4>>, Json<ApiResult<ApiError>>>{
